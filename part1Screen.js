...
const moveToExer3 = () => {
    ...
    setTimeout(() => {
        // document.getElementById("page4").style.bottom = "70vh";
...
const showCard1 = (event) => {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            // document.getElementById(`${currentCard}-text`).classList.remove("hide-text");
...
const wrongMatch = () => {
    ...
    // document.getElementById(`${chosenFirstCard}-text`).classList.add("hide-text");
    // document.getElementById(`${chosenSecondCard}-text`).classList.add("hide-text");
    ...
    setTimeout(() => {
        ...
        //     document.getElementById(`${chosenFirstCard}-text`).classList.remove("hide-text");
        //     document.getElementById(`${chosenSecondCard}-text`).classList.remove("hide-text");
        ...
        //         document.getElementById(`${chosenFirstCard}-text`).classList.add("show-text");
        //         document.getElementById(`${chosenSecondCard}-text`).classList.add("show-text");
            }, 250);
            ...
            setTimeout(() => {
                ...
                // document.getElementById(`${chosenFirstCard}-text`).style.removeProperty("box-shadow");
                // document.getElementById(`${chosenSecondCard}-text`).style.removeProperty("box-shadow");

                // cardUnGlow(document.getElementById(`${chosenFirstCard}-text`));
                // cardUnGlow(document.getElementById(`${chosenSecondCard}-text`));

                // document.getElementById(`${chosenFirstCard}-text`).style.boxShadow = "0 0 0px 0px;";
                // document.getElementById(`${chosenSecondCard}-text`).style.boxShadow = "0 0 0px 0px;";
    ...
    //     setTimeout(() => {
    //         document.getElementById(`${currentCard}-text`).classList.remove("hide-text");
    //         document.getElementById(`${currentCard}-text`).classList.add("show-text");   
    //     }, 500);
...
const showCredit = () => {
    ...
    // document.getElementById("light").setAttribute("src", "images/part3Screen/lightOn.png");

    // document.getElementById("light").src = "images/part3Screen/lightOn.png";
    // document.getAnimations("light").setAttribute("src", "images/part3Screen/lightOn.png");
}
...
const hideCredit = () => {
    ...
    // document.getElementById("light").setAttribute("src", "images/part3Screen/lightOff.png");

    // document.getElementById("light").src = "images/part3Screen/lightOff.png";
    // document.getAnimations("light").setAttribute("src", "images/part3Screen/lightOff.png");
